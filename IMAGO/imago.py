...
class IMAGO:
    ...
    def initGui(self):
        # Obtiene la ruta absoluta de la carpeta del complemento
        plugin_dir = os.path.dirname(os.path.abspath(__file__))
        icon_path = os.path.join(plugin_dir, 'icon.png')  # icon.png debe estar en la misma carpeta que el complemento

        self.select_action = QAction(QIcon(icon_path), "Open IMAGO link", self.iface.mainWindow())
